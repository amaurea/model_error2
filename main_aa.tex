...
\title{Large-scale power loss in ground-based CMB mapmaking\thanks{The source code and data files behind these examples is available at \url{https://github.com/amaurea/model_error2}. The 1D and 2D subpixel simulations are available in \texttt{subpix/model\_error\_toy.py} and \texttt{subpix/model\_error\_toy.py} respectively, while the gain error example is in \texttt{gain/gain\_model\_error\_toy\_2d.py}.}}

\author{Sigurd~Naess\inst{1}\thanks{ORCID 0000-0002-4478-7111}
\and Thibaut~Louis\inst{2}\thanks{ORCID 0000-0002-6849-4217}}
\institute{Institute of Theoretical Astrophysics, University of Oslo, Norway
\and Université Paris-Saclay, CNRS/IN2P3, IJCLab, 91405 Orsay, France}

\keywords{cosmic background radiation -- Methods: data analysis -- Cosmology: observations}

\abstract{CMB mapmaking relies on a data model to solve for the sky map, and this
...
\begin{figure}
	...
	\begin{tabular}{cc}
		...
		%\includegraphics[width=\columnwidth]{subpix/model_error_toy_2d_aa.pdf}
	\end{tabular}
	\end{closetabcols}
...
Cosmic microwave bacgrkound (CMB) telescopes observe the sky by scanning their detectors across
...
\begin{figure}
	\centering
	\hspace*{-2mm}\includegraphics[width=1.05\columnwidth]{subpix/ps_aa.pdf}
	\caption{
...
\begin{figure}
	\centering
	\hspace*{-5mm}\includegraphics[width=1.07\columnwidth]{subpix/model_error_toy_aa.pdf}
	\caption{
...
\begin{figure}
	\centering
	\hspace*{-5mm}\includegraphics[width=1.07\columnwidth]{subpix/model_error_toy_noerr_aa.pdf}
	\caption{
...
\begin{figure}
	\centering
	\hspace*{-5mm}\includegraphics[width=1.10\columnwidth]{subpix/model_error_toy_2d_aa.pdf}
	\caption{
...
\begin{figure}[h!]
	\centering
	\hspace*{-5mm}\includegraphics[width=1.10\columnwidth]{subpix/model_error_toy_2d_noise_aa.pdf}
	\caption{
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{subpix/tfun_lin_1d_aa.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=8cm]{gain/gain_toy1d_bias_aa.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=8.5cm]{gain/gain_toy2d_bias_aa.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=8.5cm]{gain/gain_toy2d_noise_aa.pdf}
...
\begin{figure}[h]
	\center
	\includegraphics[width=5cm]{pixwin/linear_defs_aa.pdf}
...
\begin{figure*}[htb]
	\center
	\includegraphics[width=12cm]{pixwin/linear_p_aa.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=8cm]{pixwin/pixwins_aa.pdf}
