...
unappreciated, and I fear that many CMB analyses
...
generalized least-squares solution for the map.\footnote{
	...
	This well-known phenomenon is \emph{not} the bias I'm exploring in
	this paper, and since I solve the equation exactly it does not
	appear here.
}
...
\begin{figure}
	...
	\caption{
		...
		I interpret the upturn at $l>0.4$ as aliasing, which
...
\begin{figure}
	\center
	\includegraphics[width=6cm]{pixwin/linear_defs.pdf}
...
\begin{figure}
	\center
	\includegraphics[width=15cm]{pixwin/linear_p.pdf}
...
on each pixel being hit equally much at all subpixel locations. For simplicity, I will assume a simple
