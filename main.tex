...
gain calibration mismatch. We show that specific case of subpixel bias can
...
\begin{align}
	...
	&= (P^TN^{-1}P)^{-1}P^TN^{-1}P^{-1}N^{-1}(Pm + n) \notag \\
	&= Pm+n
\end{align}
...
\begin{align}
	\langle\hat m\rangle &= (P^TG^{-1}N^{-1}G^{-1}P)^{-1}P^TG^{-1}N^{-1}G^{-1}Gm \notag \\
	&= (P^TG^{-1}N^{-1}G^{-1}P)^{-1}P^TG^{-1}N^{-1}m
\end{align}
Since $N$ is diagonal in Fourier space and both $G$ and $P$ are constant in time,
the whole equation becomes Fourier-diagonal
\begin{align}
	\langle\hat m_f\rangle &= (P^TG^{-1}N_f^{-1}G^{-1}P)^{-1}P^TG^{-1}N_f^{-1}m_f
\end{align}
Inserting eq.~\ref{eq:gain-toy1d-ninv}, this simplifies to ($A_f$ cancels)
\begin{align}
	\langle\hat m_f\rangle &= \frac{g_1+g_2}{g_1^2+g_2^2} \frac{1-\alpha_f}{1-\frac{2g_1g_2}{g_1^2+g_2^2}\alpha_f} m_f
\end{align}
So the effect of the gain miscalibration is an overall scaling of the result
as one would expect, $(g_1+g_2)/(g_1^2+g_2^2)$, times a transfer function
\begin{align}
