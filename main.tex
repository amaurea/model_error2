...
come at a high cost in noise.

\subsubsection{Eliminating subpixel errors}
...
the standard \lstinline{pixwin_nn = sinc(l_y)[:,None]*sinc(l_x)[None,:]}
...
\lstinline{pixwin_lin = linwin1d(l_y)[:,None]*linwin1d(l_x)[None,:]},
...
\begin{figure}
	...
	mapmaking (red, $sinc(l)$) and linear mapmaking (blue). The 2D pixel window
